...
def natural_language_to_sql(user_input_param: str):
    ...
    if use_duckdb_staging():
        from Interpreter.staging_query import natural_language_to_sql_staging

        return natural_language_to_sql_staging(user_input_param)
...
def debug_query_routing(user_input: str, model_sql: str):
    ...
    if use_duckdb_staging():
        from Interpreter.staging_query import debug_staging_routing

        return debug_staging_routing(user_input, model_sql)
