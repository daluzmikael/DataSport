...
from ingestion.stagers.phase6 import (
    run_phase6,
    stage_lineups,
...
TABLE_STAGERS = {
    ...
    "player_tracking": stage_player_tracking,
    "team_tracking": stage_team_tracking,
    "lineups": stage_lineups,
    "player_on_off": stage_player_on_off,
    "player_estimated_metrics": stage_player_estimated_metrics,
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default="1",
        help="Staging phase (1=season, 2=logs, 3=game adv, 4=career, 5=court shots, 6=extended)",
    )
    parser.add_argument(
        "--tables",
        default="",
